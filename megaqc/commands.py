...
def upload(json_files, date):
    ...
    This function allows you to submit one or more MultiQC JSON data files to MegaQC.
    ...
    to the main MegaQC installation. It imports and uses MultiQC code, so it should be
